...
const writeData = () => {
    ...
    $.ajax({
        success: function () {
            ...
            output += "<input type=\"button\" class='form-control btn btn-secondary btn' onClick=sample6_execDaumPostcode() value=\"우편번호 찾기\">";
            output += "</div>";
            output += "</div>"
            output += "<div class=\"row g-3\">"
            output += "<div class=\"col-sm-7\">";
            output += "<input type=\"text\" class='form-control' id=\"sample6_address\" placeholder=\"주소\">";
            output += "</div>";
            output += "<div class=\"col-sm\">";
            output += "<input type=\"text\" class='form-control' id=\"sample6_detailAddress\" placeholder=\"상세주소\">";
            output += "</div>";
            output += "<div class=\"col-sm\">";
