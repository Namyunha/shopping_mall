            ...
            <table class="table">
                ...
                <c:forEach items="${bookList}" var="book">
                    <tr>
                        ...
                        <td>${book.bookCount*book.unitPrice}</td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
...
<div class="m-md-3">
    <button class="w-100 btn btn-lg btn-primary" type="submit">구매하기</button>
    <button class="w-100 btn btn-lg btn-dark" type="submit">쇼핑하기</button>
</div>
</body>
</html>
